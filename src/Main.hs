...
aboutPage = pageTemplate "About Us" $ do
  H.h1 ! A.class_ "text-3xl font-bold text-jet-800 mb-4" $ "About Us"
  H.p ! A.class_ "text-jet-700 mb-4" $ "The Cambridge University Defence Tech Society brings together students from various disciplines to discuss, research, and innovate in the field of defence technology."
...
eventsPage = pageTemplate "Events Calendar" $ do
  H.h1 ! A.class_ "text-3xl font-bold text-jet-800 mb-4" $ "Events Calendar"
  H.p ! A.class_ "text-jet-700 mb-4" $ "Upcoming events:"
...
joinPage = pageTemplate "Join Us" $ do
  H.h1 ! A.class_ "text-3xl font-bold text-jet-800 mb-4" $ "Join Our Society"
  H.p ! A.class_ "text-jet-700 mb-4" $ "We welcome students from all backgrounds who are interested in defence technology."
  H.p ! A.class_ "text-jet-700 mb-4" $ "To join, please fill out our membership form:"
...
sponsorsPage = pageTemplate "Sponsors" $ do
  H.h1 ! A.class_ "text-3xl font-bold text-jet-800 mb-4" $ "Our Sponsors"
  H.p ! A.class_ "text-jet-700 mb-4" $ "We are grateful for the support of our sponsors, who help make our events and activities possible."
  ...
  H.p ! A.class_ "text-jet-700 mb-4" $ "If your company is interested in supporting the Cambridge University Defence Tech Society, please contact us at "
  H.a ! A.href "mailto:sponsorship@cudts.org" ! A.class_ "text-chili_red-500 hover:underline" $ "sponsorship@cudts.org"
  H.p ! A.class_ "text-jet-700" $ "We offer various sponsorship packages that provide visibility and engagement opportunities with our members."
